...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post employers_url, params: { employer: { email: @employer.email, first_name: @employer.first_name, last_name: @employer.last_name, surname: @employer.surname } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { email: @employer.email, first_name: @employer.first_name, last_name: @employer.last_name, surname: @employer.surname } }
